...
<html lang="en">
  ...
  <body>
    ...
    <section id="hero-section"style="background-image: url('images/image.jpeg');">
    ...
    <section id="explore" class="explore-container">
      <div class="explore-card" style="background-image: url('images/Paintings.jpeg');">
        <div class="explore-card-content">
          <h3>Paintings & Wall Art</h3>
          <a href="paintings.html">more</a>
        </div>
      </div>
      <div class="explore-card" style="background-image: url('images/Pottery.jpeg');">
        <div class="explore-card-content">
          <h3>Pottery</h3>
          <a href="pottery.html">more</a>
        </div>
      </div>
      <div class="explore-card" style="background-image: url('images/Accessories.jpeg');">
        <div class="explore-card-content">
          <h3>Accessories</h3>
          <a href="accessories.html">more</a>
        </div>
      </div>
      <div class="explore-card" style="background-image: url('images/Textiles.jpeg');">
        <div class="explore-card-content">
          <h3>Textiles</h3>
          <a href="textiles.html">more</a>
        </div>
      </div>
    </section>
      ...
      <div class="about-box">
        <div class="about-container">
          <div class="about-image">
            <img src="images/image1.jpeg" alt="About Us Image" />
          </div>
